...
| File Path | Description |
|-----------|------------|
| tickets/plan.md | Project ticket planning document. |
...
| tickets/003-skills-system/001-setup-module-structure.md | Skills system module structure setup. |
| tickets/003-skills-system/002-implement-api.md | Implement API for skills system. |
| tickets/003-skills-system/003-timeout-error-handling.md | Timeout and error handling for skills system. |
| tickets/003-skills-system/004-unit-integration-tests.md | Unit and integration tests for skills system. |
| tickets/003-skills-system/005-documentation.md | Documentation for skills system. |
| tickets/007-epic-improve-e2e-tests-setup/epic.md | Epic: Improve E2E tests setup. |
| tickets/007-epic-improve-e2e-tests-setup/001-rewrite-test-setup.md | Rewrite E2E test setup. |
| tickets/007-epic-improve-e2e-tests-setup/002-implement-parallel-execution.md | Implement parallel execution for E2E tests. |
| tickets/007-epic-improve-e2e-tests-setup/003-write-documentation.md | Write documentation for E2E test improvements. |
| tickets/004-md-support/epic.md | Epic: Markdown support improvements. |
| tickets/004-md-support/001-detect-md-files-highlighting.md | Detect markdown files and highlighting. |
| tickets/004-md-support/002-parse-md-play-button-console.md | Parse markdown play button and console output. |
| tickets/004-md-support/003-e2e-tests.md | E2E tests for markdown support. |
| tickets/005-e2e-tests-optimization/epic.md | Epic: E2E tests optimization. |
| tickets/005-e2e-tests-optimization/001-implement-shared-browser-context.md | Implement shared browser context for E2E tests. |
| tickets/005-e2e-tests-optimization/002(skiped)-add-vscode-server-pooling.md | (Skipped) Add VS Code server pooling for E2E tests. |
| tickets/005-e2e-tests-optimization/003-refactor-test-grouping-and-fixtures.md | Refactor test grouping and fixtures for E2E tests. |
| tickets/005-e2e-tests-optimization/003-refactor-test-grouping-and-fixtures-IMPLEMENTED.md | Refactor test grouping and fixtures (implemented). |
| tickets/005-e2e-tests-optimization/004-optimize-headless-mode-and-startup-flags.md | Optimize headless mode and startup flags for E2E tests. |
...
| tickets/006-playbook-execution-engine/002-typescript-support-for-skills.md | TypeScript support for skills execution. |
| tickets/006-playbook-execution-engine/003-generic-skill-highlighting.md | Generic skill highlighting for playbook execution. |
| tickets/006-playbook-execution-engine/099-execute-js-code-blocks.md | Execute JS code blocks in playbook engine. |
| tickets/006-playbook-execution-engine/IMPLEMENTATION-SUMMARY.md | Implementation summary for playbook execution engine. |
